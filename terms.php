...
<html>
    ...
    <body onload="checkMobile('terms')">
        ...
        <div class="pageContent" id="pageContent">
            <p class="para1">Your use of this website</p>
            <p class="para2">The information on this website is of a general nature only and does not address particular circumstances or requirements. 
            It is provided "as is" and without any warranty, whether express or implied. We do not accept any liability or responsibility for the accuracy, 
            completeness or usefulness of the information disclosed on this site. Information on this website may not be accurate or current. We may change 
            any information on this website at any time.<br><br>These terms of use are not intended to, and do not, create any contractual or legal rights.<br><br>
            <u>In the event that</u> you have any questions please contact us on our contact page.</p>
        </div>
        ...
        <ul class="ul2" id="footer">
            ...
            <li class="li2" onclick="location.href = 'terms.php'" style="text-decoration: underline;"><a>Terms</a></li>
        </ul>
